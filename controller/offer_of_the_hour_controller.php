<?php
  ...
  $h = $hour;
  $mm = $minute+1;
  $h1 =$year."-".$month."-".$day." ".$hour.":".$minute.":00";
  $h2 =$year."-".$month."-".$day." ".$hour.":".$mm.":00";
  $time_start =$data[3];
  ...
  if ($day === $date_end[2] && $minute >= $hour_end[1] || $hour > $hour_end[0] || $day > $date_end[2] || intval($article[5], 0) <= 0){
    if ( $old_id === $new_id){
    ...
    header("refresh:0");
      ...
      echo "<img class='center' src='".$article[13]."' width='30%'><br><br>";

      echo "<div class='center'> Price : ".$article[4]."<br>";
      ...
      echo "Age : ".$article[11]."<br></div><br><br><br>";
