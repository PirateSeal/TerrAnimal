	...
	?>
		...
		<form action="../controller/display_add_bid.php?go=add" method="POST">
				...
				The specie you want to add doesn't exist ?  <a href="../controller/display_add_bid.php?go=add_specie"> Add one</a><br>
				<br>
