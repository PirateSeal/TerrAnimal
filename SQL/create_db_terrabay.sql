...
START TRANSACTION;
USE `db_terrabay`;
INSERT INTO `db_terrabay`.`discounts` (`id_discount`, `id_article`, `status`, `date_start`, `date_end`, `init_price`, `disc_price`) VALUES (0, 1, '0', '2018-06-13 18:00:00', '2018-06-13 19:00:00', 150.00, 200.00);
