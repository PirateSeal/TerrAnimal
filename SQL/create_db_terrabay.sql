...
CREATE TABLE IF NOT EXISTS `db_terrabay`.`species` (
  `id_specie` INT(11) ZEROFILL NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_terrabay`.`users` (
  `id_user` INT(11) ZEROFILL NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_terrabay`.`articles` (
  `id_article` INT(11) ZEROFILL NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_terrabay`.`orders` (
  `id_order` INT(11) ZEROFILL NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_terrabay`.`orders_lines` (
  `id_order_line` INT(11) ZEROFILL NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_terrabay`.`discounts` (
  `id_discount` INT ZEROFILL NOT NULL AUTO_INCREMENT,
  `id_article` INT NOT NULL,
  `status` ENUM('0', '1') NOT NULL DEFAULT '0',
  `time_start` TIMESTAMP NOT NULL,
  `time_stop` TIMESTAMP NOT NULL,
  `price_start` DECIMAL(65,2) NOT NULL,
  `price_stop` DECIMAL(65,2) NOT NULL,
