...
START TRANSACTION;
USE `db_terrabay`;
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (1, 'Feral', 'oui.non@gmail.com', 'Thomas', 'Cousin', DEFAULT, NULL, 'YlhE', 500000, 'admin', NULL);
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (2, 'aze', 'aze@aze.fr', 'aze', 'aze', DEFAULT, NULL, 'TFdI', DEFAULT, DEFAULT, NULL);
