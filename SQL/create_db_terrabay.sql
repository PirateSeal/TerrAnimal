...
START TRANSACTION;
USE `db_terrabay`;
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (1, 'Feral', 'oui.non@gmail.com', 'Thomas', 'Cousin', DEFAULT, NULL, 'YlhE', 50000, 'admin', NULL);
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (2, 'Tylan', 'unmail@gmail.com', 'JeanRene', 'Bovin', DEFAULT, NULL, 'Ylhe', 99999, DEFAULT, NULL);
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (3, 'ScrubLord', 'scrub.lord@gmail.com', 'Theodule', 'Joulax', DEFAULT, NULL, 'Ylhe', 100, DEFAULT, NULL);
