...
INSERT INTO `db_terrabay`.`articles` (`id_article`, `id_specie`, `id_user`, `description`, `unit_price`, `stock`, `gender`, `diet`, `weight`, `size`, `color`, `age`, `status`, `photo_path`) VALUES (55, 9, 2, 'White Rabbit', 1000, 2, '0', 'carnivorous', 3, 0.5, 'White', 3, 'available', '../model/resources/rabbit.jpg');
INSERT INTO `db_terrabay`.`articles` (`id_article`, `id_specie`, `id_user`, `description`, `unit_price`, `stock`, `gender`, `diet`, `weight`, `size`, `color`, `age`, `status`, `photo_path`) VALUES (56, 9, 2, 'Red Rabbit', 1000, 2, '0', 'carnivorous', 3, 0.5, 'Red', 3, 'available', '../model/resources/rabbit1.jpg');
INSERT INTO `db_terrabay`.`articles` (`id_article`, `id_specie`, `id_user`, `description`, `unit_price`, `stock`, `gender`, `diet`, `weight`, `size`, `color`, `age`, `status`, `photo_path`) VALUES (57, 9, 2, 'Brown Rabbit', 1000, 2, '0', 'carnivorous', 3, 0.5, 'Brown', 3, 'available', '../model/resources/rabbit2.jpg');
INSERT INTO `db_terrabay`.`articles` (`id_article`, `id_specie`, `id_user`, `description`, `unit_price`, `stock`, `gender`, `diet`, `weight`, `size`, `color`, `age`, `status`, `photo_path`) VALUES (58, 9, 2, 'Fox', 1000, 2, '0', 'carnivorous', 3, 0.5, 'Red', 3, 'available', '../model/resources/fox1.jpg');
