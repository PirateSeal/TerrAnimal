...
START TRANSACTION;
USE `db_terrabay`;
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (1, 'Feral', 'oui.non@gmail.com', 'Thomas', 'Cousin', 2.5, NULL, 'YlhE', 50000, 'admin', NULL);
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (2, 'Tylan', 'unmail@gmail.com', 'JeanRene', 'Bovin', 2.5, NULL, 'Ylhe', 99999, DEFAULT, NULL);
INSERT INTO `db_terrabay`.`users` (`id_user`, `pseudo`, `email`, `firstname`, `name`, `note`, `vote_nbr`, `password`, `balance`, `status`, `photo_path`) VALUES (3, 'ScrubLord', 'scrub.lord@gmail.com', 'Theodule', 'Joulax', 2.5, NULL, 'Ylhe', 100, DEFAULT, NULL);
...
START TRANSACTION;
USE `db_terrabay`;
INSERT INTO `db_terrabay`.`articles` (`id_article`, `id_specie`, `id_user`, `description`, `unit_price`, `stock`, `gender`, `diet`, `weight`, `size`, `color`, `age`, `status`, `photo_path`) VALUES (1, 1, 1, 'Chat', 25, 99999, '0', 'carnivorous', 2, 0.5, 'Dark brown', 2, 'available', '../model/resources/cat1.jpg');
